...
export function GameCard({ game, status }: { game: GameDefinition; status: keyof typeof LABEL }) {
  ...
  function openGame() { startGame(); router.push(`/games/${game.slug}`); }

  return <article className="student-game-card">
    ...
    <div className="student-game-copy">
      <div className="game-meta"><span><Clock3 /> {game.estimatedMinutes} min</span><span><MessageCircle /> Feel · Build · Talk</span></div>
