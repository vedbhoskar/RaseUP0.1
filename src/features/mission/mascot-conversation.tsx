...
export function MascotConversation({ attempt, onChange, onNext, onBack, canContinue, finalStageId }: { attempt: GameAttempt; onChange: (attempt: GameAttempt) => void; onNext: () => void; onBack: () => void; canContinue: (attempt: GameAttempt) => boolean; finalStageId: TalkStageId }) {
